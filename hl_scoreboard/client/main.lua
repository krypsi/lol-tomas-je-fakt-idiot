...
Citizen.CreateThread(function()
	...
	Citizen.Wait(2000)
	ESX.TriggerServerCallback('hl_scoreboard:getConnectedPlayers', function(connectedPlayers)
...
Citizen.CreateThread(function()
	...
	SendNUIMessage({
		...
		uptime = 'discord.gg/BDeMNqferV',
		playTime = '00h 00m'
	})
end)

RegisterNetEvent('hl_scoreboard:updateConnectedPlayers')
AddEventHandler('hl_scoreboard:updateConnectedPlayers', function(connectedPlayers)
	UpdatePlayerTable(connectedPlayers)
end)

RegisterNetEvent('hl_scoreboard:updatePing')
AddEventHandler('hl_scoreboard:updatePing', function(connectedPlayers)
	SendNUIMessage({
		action  = 'updatePing',
...
RegisterNetEvent('hl_scoreboard:toggleID')
AddEventHandler('hl_scoreboard:toggleID', function(state)
	if state then
		idVisable = state
	else
